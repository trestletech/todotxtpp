...
global.PORT = process.env.TODOPORT || 3000;

var server;
if (process.env.TODOKEY && process.env.TODOCERT){
  server = require('https').createServer({
      key: fs.readFileSync(process.env.TODOKEY),
      cert: fs.readFileSync(process.env.TODOCERT)
    }, app).listen(PORT);
